...
import { 
  ...
  XCircle, 
  AlertCircle, 
  Stethoscope // Added for Doctor context
} from 'lucide-react';
...
interface DoctorDetailsModalProps {
  show: boolean;
  booking: DoctorBooking | null;
  onClose: () => void;
}

const DoctorDetailsModal: React.FC<DoctorDetailsModalProps> = ({ show, booking, onClose }) => {
  ...
  // Helper to format time strings (handling both ISO dates or simple time strings)
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
          <div className="modal-content border-0 shadow-lg">
            ...
            <div className="modal-header ml-6 border-0 text-white position-relative" style={{
              ...
              <div>
                <h3 className="modal-title fw-bold mb-2 h4">Doctor Appointment Details</h3>
                <p className="mb-0 opacity-75 small">Booking ID: {booking.id}</p>
              </div>
              <button
                type="button"
            ...
            <div className="modal-body bg-body-secondary" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
              {/* Status Badge */}
              <div className="mb-4">
                <span className={`badge ${statusConfig.bgClass} border d-inline-flex align-items-center gap-2 fw-semibold py-2 px-3 fs-6`}>
                  {statusConfig.icon}
                  {statusConfig.text}
                </span>
              </div>
                      ...
                      <div className="d-flex flex-column gap-3">
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="mb-0 fw-semibold text-body fs-6">{booking.user_full_name}</p>
                          </div>
                        </div>
                        ...
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="mb-0 text-body text-break fs-6">{booking.user_email}</p>
                          </div>
                        </div>
                        ...
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="mb-0 fw-semibold text-body fs-6">{booking.user_phone_number}</p>
                          </div>
                        </div>
                        ...
                        {booking.user_id && (
                          <div className="d-flex gap-3">
                            ...
                            <div className="flex-grow-1">
                              <label className="text-muted text-uppercase mb-1 d-block fw-medium small" style={{ letterSpacing: '0.5px' }}>Patient ID</label>
                              <p className="mb-0 font-monospace text-secondary fs-6">{booking.user_id}</p>
                            </div>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="card-body p-4">
                      <h5 className="card-title py-3 d-flex align-items-center gap-2 mb-4 h6">
                        <div className="bg-info bg-opacity-10 p-8 rounded">
                          <Stethoscope size={20} className="text-info" />
                        </div>
                        <span className="fw-semibold">Doctor Information</span>
                      </h5>
                      
                      <div className="d-flex flex-column gap-3">
                        <div className="d-flex gap-3">
                          <Stethoscope size={20} className="text-muted mt-1" style={{ flexShrink: 0 }} />
                          <div className="flex-grow-1">
                            <label className="text-muted text-uppercase mb-1 d-block fw-medium small" style={{ letterSpacing: '0.5px' }}>Doctor Name</label>
                            <p className="mb-0 fw-semibold text-body fs-6">{booking.doctor_name_en}</p>
                          </div>
                        </div>
                        ...
                        {booking.doctor_id && (
                          <div className="d-flex gap-3">
                            ...
                            <div className="flex-grow-1">
                              <label className="text-muted text-uppercase mb-1 d-block fw-medium small" style={{ letterSpacing: '0.5px' }}>Doctor ID</label>
                              <p className="mb-0 font-monospace text-secondary fs-6">{booking.doctor_id}</p>
                            </div>
                          </div>
                        )}
                        
                        <div className="d-flex gap-3">
                          <Clock size={20} className="text-muted mt-1" style={{ flexShrink: 0 }} />
                          <div className="flex-grow-1">
                            <label className="text-muted text-uppercase mb-1 d-block fw-medium small" style={{ letterSpacing: '0.5px' }}>Reserved Time Slot</label>
                            <p className="mb-0 fw-semibold text-body fs-6">
                              {formatTimeStr(booking.time_slot_start_time)} - {formatTimeStr(booking.time_slot_end_time)}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="mb-0 fw-semibold text-body fs-6">{booking.type}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="card h-100 border-0 p-3 shadow-sm hover-shadow-lg transition bg-body">
                    <div className="card-body p-4">
                      <h5 className="card-title py-3 d-flex align-items-center gap-2 mb-4 h6">
                        ...
                        <span className="fw-semibold">Branch & Date</span>
                      </h5>
                      ...
                      <div className="d-flex flex-column gap-3">
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="mb-0 fw-semibold text-body fs-6">{booking.branch_name_en}</p>
                          </div>
                        </div>
                        ...
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="mb-0 fw-semibold text-body fs-6">{booking.branch_name_ar}</p>
                          </div>
                        </div>
                        ...
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="mb-0 font-monospace text-secondary fs-6">{booking.branch_id}</p>
                          </div>
                        </div>
                        ...
                        <div className="d-flex gap-3">
                          ...
                          <div className="flex-grow-1">
                            <label className="text-muted text-uppercase mb-1 d-block fw-medium small" style={{ letterSpacing: '0.5px' }}>Appointment Date</label>
                            <p className="mb-0 fw-semibold text-body fs-6">{formatDate(booking.booking_date)}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="card h-100 border-0 p-3 shadow-sm hover-shadow-lg transition bg-warning bg-opacity-10">
                    <div className="card-body p-4">
                      <h5 className="card-title py-3 d-flex align-items-center gap-2 mb-4 h6">
                        ...
                        <span className="fw-semibold">Pricing Details</span>
                      </h5>
                      ...
                      <div className="d-flex flex-column gap-2">
                        <div className="d-flex justify-content-between align-items-center pb-2 border-bottom border-warning border-opacity-25">
                          ...
                          <span className="fw-semibold text-body fs-6">﷼{booking.actual_price || '0.00'}</span>
                        </div>
                        ...
                        {parseFloat(discountAmount) > 0 && (
                          <>
                            ...
                            <div className="d-flex justify-content-between align-items-center pb-2 border-bottom border-warning border-opacity-25">
                              ...
                              <span className="fw-semibold text-body fs-6">﷼{booking.discounted_price || '0.00'}</span>
                            </div>
                          </>
                        )}
